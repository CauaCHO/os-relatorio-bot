        ...
        "secoes": [
            {
                ...
                "campos": [
                    ...
                    {"id": "teste_velocidade", "item": "1.6", "titulo": "Realização de teste de velocidade", "tipo": "texto"},
                    {"id": "canal_24", "item": "1.7", "titulo": "Melhor canal da rede 2.4Ghz", "tipo": "canal24"},
                    {"id": "canal_5", "item": "1.7.1", "titulo": "Melhor canal da rede 5Ghz", "tipo": "canal5"},
            ...
            },
            {
                ...
                "campos": [
                    {"id": "materiais_utilizados", "item": "3.1", "titulo": "Material utilizado/retirado", "tipo": "texto"},
        ...
        "secoes": [
            {
                ...
                "campos": [
                    ...
                    {"id": "teste_velocidade", "item": "1.7", "titulo": "Realização de teste de velocidade", "tipo": "texto"},
                    {"id": "canal_24", "item": "1.8", "titulo": "Melhor canal da rede 2.4Ghz", "tipo": "canal24"},
                    {"id": "canal_5", "item": "1.8.1", "titulo": "Melhor canal da rede 5Ghz", "tipo": "canal5"},
        ...
        "secoes": [
            {
                ...
                "campos": [
                    ...
                    {"id": "teste_velocidade", "item": "1.8", "titulo": "Realização de teste de velocidade", "tipo": "texto"},
                    {"id": "canal_24", "item": "1.9", "titulo": "Melhor canal da rede 2.4Ghz", "tipo": "canal24"},
                    {"id": "canal_5", "item": "1.9.1", "titulo": "Melhor canal da rede 5Ghz", "tipo": "canal5"},
        ...
        "secoes": [
            {
                "titulo": "SEÇÃO 1 - PADRÃO DE FINALIZAÇÃO",
                "campos": [
                    {"id": "modelo_segundo_roteador", "item": "1.1", "titulo": "Modelo do roteador do segundo ponto / SSID e senha", "tipo": "texto"},
                    {"id": "local_instalacao", "item": "1.2", "titulo": "Local da instalação dos equipamentos", "tipo": "texto"},
                    {"id": "config_padrao", "item": "1.3", "titulo": "Configurações do roteador dentro do padrão (primeiro e segundo ponto)", "tipo": "sim_nao"},
                    {"id": "passagem_cabo", "item": "1.4", "titulo": "Passagem de cabo de rede com testes", "tipo": "sim_nao"},
                    {"id": "teste_velocidade", "item": "1.5", "titulo": "Realização de teste de velocidade", "tipo": "texto"},
        ...
        "secoes": [
            {
                ...
                "campos": [
                    ...
                    {"id": "teste_velocidade", "item": "1.4", "titulo": "Realização de teste de velocidade", "tipo": "texto"},
                    {"id": "sinal_fibra", "item": "1.5", "titulo": "Medição de sinal da Fibra", "tipo": "sinal"},
                    {"id": "houve_dano", "item": "1.6", "titulo": "Informado se houve dano no local", "tipo": "sim_nao"},
                    {"id": "descricao_dano", "item": "1.6.1", "titulo": "Descrição do dano no local", "tipo": "texto", "condicao": {"campo": "houve_dano", "valor": "Sim"}},
                    {"id": "canal_24", "item": "1.7", "titulo": "Melhor canal da rede 2.4Ghz", "tipo": "canal24"},
